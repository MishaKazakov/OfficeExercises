...
public class EndTimeTimePicker extends DialogPreference {
    private TimePicker timePicker;
    private Context mContext;
    private int hour;
    private int minute;

    public EndTimeTimePicker (Context context, AttributeSet attributeSet){
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        editor.putString("endNotification", time);
        editor.commit();
